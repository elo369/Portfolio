    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        <div className="text-3xl md:text-5xl text-white lg:text-6xl font-bold  relative inline-block">
            Contact <span className="bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-transparent bg-clip-text">Me</span>
            <motion.div 
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://x.com/rohitrikame88" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://github.com/elo369" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://www.linkedin.com/in/rohit-rikame-6423a0288/" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
