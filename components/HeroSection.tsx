...
const HeroSection = () => {
  return (
    <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 bg-black z-1 min-h-screen top-4">
      ...
      <button className="shadow-[0_4px_14px_0_rgb(0,118,255,39%)] hover:shadow-[0_6px_20px_rgba(0,118,255,23%)] hover:bg-[rgba(0,118,255,0.9)] md:px-8 md:py-2 bg-[#0070f3] rounded-md text-white font-light transition duration-200 ease-linear z-1 px-6 py-1 relative md:top-0 sm:top-3 top-8">
        <Link 
